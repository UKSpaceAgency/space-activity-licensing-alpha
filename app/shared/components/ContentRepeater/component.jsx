...
const ContentRepeater = props => {
  ...
  let collapsible = props.commentBlock && props.commentBlock.collapsible && props.commentBlock.tabs ? (<Accordion><div className='accordion-section'><div className='accordion-section-header'>Application notes</div><div className='accordion-section-body'>{tabs}</div></div></Accordion>) : tabs
  return (
